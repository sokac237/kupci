...
namespace Kupci
{
    public partial class frmProdajaArtik : Form
    {
        ...
        public frmProdajaArtik()
        {
            InitializeComponent();
        }

        private void frmProdajaArtik_Load(object sender, EventArgs e)
        {
        ...
        private void frmProdajaArtik_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btnPrikazi_Click(object sender, EventArgs e)
        {
            ...
            if (glPoslovnica.Text != "" && dtOd.Value != null && dtDo.Value != null)
            {
                ...
                try
                {
                    ...
                    MySqlCommand upit1 = new MySqlCommand("select a.ar_sifra as 'Šifra', a.ar_naziv as 'Naziv',sum(z.ra_kolicina) as 'Količina',"+
                        "sum(z.ra_kolicina*z.ra_cijena) as 'Promet' ," +
                        "sum(z.ra_ruc) as 'Zarada' from " + katalog + ".zalkart z, " + katalog + ".artik a where z.ar_sifra = a.ar_sifra and "+
